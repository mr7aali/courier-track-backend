...
export class PaymentsService {
  ...
  constructor() {
    ...
    this.paymentModel = InjectModel(Payment.name)
  }

  async create(createPaymentDto: CreatePaymentDto, customerId: string): Promise<Payment> {
  ...
  async getPaymentStats() {
    ...
    const codPayments = await this.paymentModel.countDocuments({ paymentType: "cod", status: "completed" })
    const onlinePayments = await this.paymentModel.countDocuments({ paymentType: "online", status: "completed" })
