...
export class TrackingController {
  ...
  updateParcelLocation(parcelId: string, @Body() body: { latitude: number; longitude: number; address?: string }) {
    return this.trackingService.updateParcelLocation(parcelId, body.latitude, body.longitude, body.address)
  }
