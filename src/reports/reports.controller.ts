...
export class ReportsController {
  ...
  async generateParcelReport(startDate: string, endDate: string, format: "csv" | "pdf" = "csv", @Res() res: Response) {
  ...
  async generateRevenueReport(startDate: string, endDate: string, format: "csv" | "pdf" = "csv", @Res() res: Response) {
    const start = new Date(startDate)
    const end = new Date(endDate)
  ...
  async generateAgentReport(format: "csv" | "pdf" = "csv", @Res() res: Response) {
